<?php   
        ...
        $sql = "SELECT * FROM Applicant WHERE APPID='$id'";
...
<html>
  <head>
    <title>Username | Akhlas International Mart</title>
	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><a href="home.php">Akhlas International Mart</a></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="#"><i class="glyphicon glyphicon-stats"></i>AIM Market</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-comment"></i>Community</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-record"></i>Oppourtunities</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-th-large"></i> Events</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-globe"></i> Projects</a></li>
                    <li class="submenu">
                         <a href="#">
                            <i class="glyphicon glyphicon-list"></i> Insides
		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-primary">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Dream Come True.</div>
						
					
		  			</div>
		  			<div class="content-box-large box-with-header">
			  		   <p style="margin-bottom:0;font-size:20px;"><img src="images/user.png" alt="Profile Image"><a href="#" style="color:black;"> <?php echo $FullName;?></a></p>
			  		   <p style="margin-top:0;margin-left:28px;"><?php echo $Email;?></p>
		  			...
		  			<div class="row">
		  				<div class="col-md-12">
		  					<div class="content-box-header">
			  					<div class="panel-title">Your Package</div>
					  		...
					  		<?php
			  		           ...
			  		           echo "<script>alert('$Package');</script>";
			  		            ...
			  		            if($Package=="BASIC"){
			  		                ...
			  		                echo '<img src="images/basic.png" alt="Basic" style="width:50px; height:auto;"> BASIC PLAN';
			  		                
			  		            }if($Package=="PREMIUM"){
			  		                
			  		                echo '<img src="images/premium.png" alt="Basic" style="width:50px; height:auto;"> PREMIUM PLAN';
			  		                
			  		            }if($Package=="PROFESSIONAL"){
			  		                
			  		                echo '<img src="images/professional.png" alt="Basic" style="width:50px; height:auto;"> PROFESSIONAL PLAN';
    ...
    <footer>
         <div class="container">
            ...
            <div class="copy text-center">
               Copyright 2018. &copy; <a href='#'>Akhlas International Mart - AIM</a>
            </div>
...
<?php }
       ...
       echo '<script>window.location.href="https://aksintmart.com";</script>';
   }
